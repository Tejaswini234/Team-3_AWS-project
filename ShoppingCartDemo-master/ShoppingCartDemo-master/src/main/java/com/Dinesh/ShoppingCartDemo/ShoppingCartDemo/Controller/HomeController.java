...
public class HomeController {
    ...
    ShoppingCart shoppingCart=new ShoppingCart("Malabar");

    @PostConstruct
    public void addcustomers(){

        shoppingCart.add_item(new Items("Earing",45.5,120));
        shoppingCart.add_item(new Items("Necklace",122.5,520));
        shoppingCart.add_item(new Items("Rings",12.5,320));
